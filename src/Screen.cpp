...
Screen::Screen(sf::IntRect window_size, int scale, 
               int toolbar_icon_padding, int toolbar_icon_size,
               int tile_palette_offset, int toolbar_offset, const int tile_map_sprite_size)
...
const sf::IntRect Screen::GetTilePaletteArea() const {
    return sf::IntRect(0, 0, tile_palette_offset * 2 + (tile_map_sprite_size * scale),
                       window_size.height);
}

const sf::IntRect Screen::GetToolbarArea() const {
    return sf::IntRect(tile_palette_offset * 2 + (tile_map_sprite_size * scale), 0,
